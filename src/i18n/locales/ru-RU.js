...
export default {
  ...
  dashboard: {
    ...
    nextPeriodErrors: {
      notAllowed: 'Досрочный запуск нового цикла трафика не разрешён',
      trafficNotUsedUp: 'Трафик ещё не израсходован, нельзя досрочно начать новый цикл',
      notEnoughTime: 'Недостаточно оставшегося времени подписки для нового цикла',
      invalidPeriod: 'Недопустимый период сброса тарифа',
      userNotExist: 'Пользователь не существует',
      saveFailed: 'Операция не выполнена, повторите попытку позже'
    },
